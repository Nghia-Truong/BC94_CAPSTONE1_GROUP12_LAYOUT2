            ...
            (function () {
              ...
              function closeAllDropdowns(event) {
                ...
                const isButtonInsideDropdown = [
                  ...document.querySelectorAll(`.astronav-dropdown button, .astronav-dropdown label, .astronav-dropdown input,
	  ...
	  #astronav-menu`),
              ...
              function closeMenu(menu) {
                ...
                const dropdownToggles =
                  menu.querySelectorAll(".dropdown-toggle");
              ...
              function handleCloseOnClick() {
                ...
                const navLink =
                  navMenuItems && navMenuItems.querySelectorAll("a");

                const MenuIcons =
                  navToggle.querySelectorAll(".astronav-toggle");
